...
void keyboard(unsigned char key, int i, int j)
{
     ...
     case '2' : x_final = x_final+1; gerak = 1; break;
     case '3' : x_final = x_final-1; gerak = 1; break;
     case '4' : y_final = y_final+1; gerak = 1; break;
     case '5' : y_final = y_final-1; gerak = 1; break;
     case '6' : z_final = z_final+1; gerak = 1; break;
     case '7' : z_final = z_final-1; gerak = 1; break;
     case '8' : x_final = L0; y_final = 0; z_final = L1+L2+L3; gerak = 1; break;
	 //case '6' : x_final = 0; y_final = 0; z_final = 0.2; gerak = 1; break;
	 case 'q' : q1 += 5*DTR;break;
	 case 'w' : q2 += 5*DTR;break;
	 case 'e' : q3 += 5*DTR;break;
	 case 'r' : q4 += 5*DTR;break;
	 case 't' : q5 += 5*DTR;break;
	 case 'y' : q6 += 5*DTR;break;
	//arah gerak
	//Kamera	
